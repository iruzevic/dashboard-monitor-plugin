...
class Dashboard_Monitor {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Dashboard_Monitor_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Dashboard_Monitor_Loader. Orchestrates the hooks of the plugin.
	 * - Dashboard_Monitor_i18n. Defines internationalization functionality.
	 * - Dashboard_Monitor_Admin. Defines all hooks for the admin area.
	 * - Dashboard_Monitor_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-dashboard-monitor-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-dashboard-monitor-i18n.php';
	 ...
	 *
	 * Uses the Dashboard_Monitor_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Dashboard_Monitor_i18n();
	 ...
	 *
	 * @since     1.0.0
	 * @return    Dashboard_Monitor_Loader    Orchestrates the hooks of the plugin.
	 */
